...
@Component({
	selector: "ng-diy-ui-input-file",
	templateUrl: "./ng-diy-ui-input-file.component.html",
	styleUrls: ["./ng-diy-ui-input-file.component.scss"],
	animations: [
		trigger("dragFiles", [
			state(
				"hold",
...
export class NgDiyUiInputFileComponent implements OnInit {
	...
	src = new Observable<string>((observer) => {
		...
		reader.onload = async (e: any) => {
			if (
				typeof e.target.result === null ||
				typeof e.target.result !== "string"
			)
				throw new Error("Result isn't string");
